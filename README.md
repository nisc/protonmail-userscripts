...
Welcome to the ProtonMail Userscripts repository! This collection includes various user scripts designed to enhance your experience with ProtonMail, the secure email service developed by Proton AG. For more information on ProtonMail and its capabilities, visit the [official Proton website](https://proton.me). **Please note that I am in no way affiliated with Proton AG.**
...
- Any changes to ProtonMail's functionality or behavior
...
3. **Future Changes**:
   - Scripts may need updates when ProtonMail changes
